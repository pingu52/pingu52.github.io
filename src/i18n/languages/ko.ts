...
export const ko: Translation = {
	...
	[Key.visitorCounterNotConfigured]: "설정되지 않음",
	[Key.visitorCounterTotal]: "누적 방문자",
	[Key.visitorCounterRecent]: "최근 {days}일",
	[Key.visitorCounterToday]: "오늘",
	...
	[Key.archiveNoJsNotice]:
		"아카이브 필터 및 구형 링크 리다이렉트는 JavaScript가 필요합니다. 사이드바의 태그/카테고리를 이용하거나 /tag/... 또는 /category/... 주소로 이동해주세요.",
	[Key.archiveDescription]:
		"게시일 기준으로 전체 글을 모아봅니다. 필터된 피드는 태그/카테고리를 이용하세요.",
};
